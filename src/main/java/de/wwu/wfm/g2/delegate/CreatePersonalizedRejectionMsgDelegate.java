...
@Component
public class CreatePersonalizedRejectionMsgDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(CreatePersonalizedRejectionMsgDelegate.class);
