...
@Component
public class SendPersonalizedRejectionMsgDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(SendPersonalizedRejectionMsgDelegate.class);
