...
@Component
public class UpdateRejectListDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(UpdateRejectListDelegate.class);
