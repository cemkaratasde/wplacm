...
@Component
public class SendCandidateSelectionDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(SendCandidateSelectionDelegate.class);
