...
@Component
public class RetrievePersonalDataDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(RetrievePersonalDataDelegate.class);
