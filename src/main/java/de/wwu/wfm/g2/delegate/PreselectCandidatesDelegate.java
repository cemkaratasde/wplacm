...
@Component
public class PreselectCandidatesDelegate implements JavaDelegate {
    private static final Logger logger = LoggerFactory.getLogger(PreselectCandidatesDelegate.class);
